using AttrRoutingAPI.Models;

namespace AtributteRoutingAPI.Migrations
{
   using System;
   ...
   internal sealed class Configuration : DbMigrationsConfiguration<AttrRoutingAPI.Models.AttrRoutingAPIContext>
   {
      ...
      protected override void Seed(AttrRoutingAPI.Models.AttrRoutingAPIContext context)
      {
